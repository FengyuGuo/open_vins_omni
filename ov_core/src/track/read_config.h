#ifndef OV_CORE_READ_CONFIG_H_
#define OV_CORE_READ_CONFIG_H_
#include "utils.h"
#include <iostream>
...
struct Configs{
  ...
  Configs(const std::string& config_file, const std::string& model_dir){
    ...
    std::cout << "model dir is " << model_dir << std::endl;
    ...
    std::cout << "super point onnx: " << superpoint_config.onnx_file << std::endl;
